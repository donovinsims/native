      ...
      <nav className="orchids-nav">
        <div className="orchids-nav-inner">
          ...
          <div className="orchids-nav-left">
            {/* Logo */}
            <Link to="/" className="orchids-nav-logo" aria-label="Home">
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`orchids-nav-item ${
                    location.pathname === item.href ? 'orchids-nav-item-active' : 'orchids-nav-item-inactive'
                  }`}
                >
                  {item.label}
                </Link>
          ...
          <div className="orchids-nav-right">
            ...
            {/* Sign In Button */}
            <button onClick={onSignInClick} className="orchids-btn orchids-btn-secondary">
              Sign in
            </button>

            {/* Create Account Button */}
            <button onClick={onCreateAccountClick} className="orchids-btn orchids-btn-primary">
              Create Account
            </button>
          </div>
